...
namespace TestingTempateFakeJson.Bases
{
    public class RequestBase
    {
        ...
        {
            IRestResponse<dynamic> response = TestingTempateFakeJsonHelpers.ExecuteRequest(url, requestService, method, headers, cookies, parameters, jsonBody, httpBasicAuthenticator, ntlmAuthenticator);
